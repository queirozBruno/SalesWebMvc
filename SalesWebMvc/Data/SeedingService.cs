...
namespace SalesWebMvc.Data
{
    ...
    {
        //Registra uma dependência com o DBContext
        private SalesWebMvcContext _context;

        //Quando o Seeding Service for criado vai receber, automaticamente, uma instância do context
        public SeedingService(SalesWebMvcContext context)
        {
            _context = context;
        }

        //Responsável por popular a base de dados. Vou chamar dentro do método Configure, da classe Startup
        public void Seed()
        {
            //Testa se já existe algum dado
            ...
            _context.Department.AddRange(d1, d2, d3, d4); ; //O objeto AddRange permite adicionar vários registros de uma vez
